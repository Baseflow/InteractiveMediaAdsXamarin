...
var solutionName = "InteractiveMediaAds";
var repoName = "martijn00/InteractiveMediaAdsXamarin";
    ...
    .Does(() => 
{
    ...
    foreach(var file in files)
    {
        ...
        var arguments = new ProcessArgumentBuilder()
            ...
            .AppendSwitchQuoted("-n", "InteractiveMediaAds")
            .AppendSwitchQuoted("-d", "InteractiveMediaAds")
